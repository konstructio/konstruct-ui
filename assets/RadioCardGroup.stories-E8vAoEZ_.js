import{r as l,j as e}from"./iframe-CoBiGKUL.js";import{R as x,S as o}from"./civo-logo-Dss8qohS.js";import{a as b,c as d}from"./index-BIgQ6y5l.js";import{T as s}from"./Typography-DZ3by0j3.js";import"./preload-helper-PPVm8Dsz.js";import"./Card-BH338vZq.js";import"./Radio-oTNe0I8O.js";const N=b(["flex"],{variants:{direction:{row:["flex-row","gap-8"],col:["flex-col","gap-4"]}},defaultVariants:{direction:"col"}}),n=({className:r,defaultChecked:m,direction:p,name:c,options:u,theme:C,wrapperClassName:h,onValueChange:i})=>{const[v,f]=l.useState(m),g=l.useCallback(a=>{f(a),i?.(a)},[i]);return e.jsx("div",{className:d(N({className:h,direction:p})),"data-theme":C,children:u.map(({value:a,...w})=>e.jsx(x,{value:a,name:c,className:d(r),checked:v===a,onChange:()=>g(a),...w},a))})};n.__docgenInfo={description:`A group of card-style radio buttons with shared state management.
