import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as c}from"./iframe-es3ybDkk.js";import{c as u,a}from"./index-CJCZd66Q.js";import"./preload-helper-D9Z9MdNV.js";const v=u(["h-2","rounded-full","overflow-hidden","mt-4","bg-zinc-200"]),x=u(["h-full","bg-[length:100%_100%]","animate-gradient-move"],{variants:{status:{success:"",progress:"",error:""}},compoundVariants:[{status:"progress",class:["bg-linear-to-r from-[#81e2b4] to-kubefirst-primary"]},{status:"success",class:["bg-[#81E2B4]"]}],defaultVariants:{status:"success"}}),t=({backgroundBarClassName:l,label:s,labelClassName:i,labelWrapperClassName:o,percent:r,percentClassName:m,progressBarClassName:p,status:d,theme:g,wrapperClassName:f})=>e.jsxs("div",{className:a("w-full text-inherit",f),"data-theme":g,children:[e.jsxs("div",{className:a("flex font-semibold",{"justify-between":s,"justify-end":!s},o),children:[s?e.jsx("label",{className:a(i),children:s}):null,e.jsxs("span",{className:a(m),children:[r,"%"]})]}),e.jsx("div",{className:a(v({className:l})),children:e.jsx("div",{className:a(x({status:d,className:p}),r>0&&r<99?"transition-width duration-500":"transition-colors duration-0"),style:{width:`${r}%`}})})]});t.__docgenInfo={description:"",methods:[],displayName:"ProgressBar",props:{backgroundBarClassName:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:""},labelClassName:{required:!1,tsType:{name:"string"},description:""},labelWrapperClassName:{required:!1,tsType:{name:"string"},description:""},percent:{required:!0,tsType:{name:"number"},description:""},percentClassName:{required:!1,tsType:{name:"string"},description:""},progressBarClassName:{required:!1,tsType:{name:"string"},description:""},status:{required:!1,tsType:{name:"union",raw:"'success' | 'progress'",elements:[{name:"literal",value:"'success'"},{name:"literal",value:"'progress'"}]},description:""},theme:{required:!1,tsType:{name:"union",raw:`| 'kubefirst'
| 'civo'
| 'kubefirst-dark'
| 'civo-dark'
| undefined`,elements:[{name:"literal",value:"'kubefirst'"},{name:"literal",value:"'civo'"},{name:"literal",value:"'kubefirst-dark'"},{name:"literal",value:"'civo-dark'"},{name:"undefined"}]},description:""},wrapperClassName:{required:!1,tsType:{name:"string"},description:""}},composes:["VariantProps"]};const h={title:"In Review/ProgressBar",component:t},n={render:function(){const[s,i]=c.useState(10);return c.useEffect(()=>{const o=setInterval(()=>{i(r=>r>=100?0:r+5)},1500);return()=>{clearInterval(o)}},[]),e.jsxs("div",{className:"max-w-[350px] flex flex-col gap-2",children:[e.jsx(t,{label:"Provisioning cluster:",percent:80,status:"progress"}),e.jsx("div",{className:"mt-3"}),e.jsx(t,{label:"Completed!",status:"success",percent:100}),e.jsx("div",{className:"mt-3"}),e.jsx(t,{label:"Provisioning:",status:s===100?"success":"progress",percent:s})]})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
