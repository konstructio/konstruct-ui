import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{o as n,t as r}from"./iframe-DOHQXGoU.js";import{a as i,n as a,r as o,t as s}from"./dist-C7OvCdCY.js";import{r as c,t as l}from"./dist-DdSJsNHD.js";import{n as u,t as d}from"./Radio-RZoK-3A2.js";var f,p=e((()=>{a(),f=s([`flex`],{variants:{direction:{row:[`flex-row`,`gap-8`],col:[`flex-col`,`gap-4`]}},defaultVariants:{direction:`col`}})})),m,h,g,_=e((()=>{c(),m=t(n(),1),i(),u(),p(),h=r(),g=({asChild:e,className:t,defaultChecked:n,direction:r,name:i,options:a,theme:s,value:c,wrapperClassName:u,onValueChange:p})=>{let g=e?l:`div`,_=c!==void 0,[v,y]=(0,m.useState)(()=>n),b=_?c:v,x=(0,m.useCallback)(e=>{_||y(e),p?.(e)},[_,p]);return(0,h.jsx)(g,{className:o(f({className:u,direction:r})),"data-theme":s,children:a.map(({value:e,...n})=>(0,h.jsx)(d,{value:e,name:i,className:o(t),checked:b===e,onChange:()=>x(e),...n},e))})},g.__docgenInfo={description:`A group of radio buttons with shared state management.
