import{r as o,j as e}from"./iframe-Dv_ed3hk.js";import{R as g,S as i}from"./civo-logo-C7FBQkzE.js";import{c as N,a as d}from"./index-Bn42e07n.js";import{T as s}from"./Typography-Cb2Ps2fx.js";import"./preload-helper-PPVm8Dsz.js";import"./Card-DbqTJnRS.js";import"./Radio-BUZnUPaW.js";const b=N(["flex"],{variants:{direction:{row:["flex-row","gap-8"],col:["flex-col","gap-4"]}},defaultVariants:{direction:"col"}}),r=({className:n,defaultChecked:m,direction:p,name:c,options:u,theme:C,wrapperClassName:h,onValueChange:t})=>{const[v,f]=o.useState(m),w=o.useCallback(a=>{f(a),t?.(a)},[t]);return e.jsx("div",{className:d(b({className:h,direction:p})),"data-theme":C,children:u.map(({value:a,...x})=>e.jsx(g,{value:a,name:c,className:d(n),checked:v===a,onChange:()=>w(a),...x},a))})};r.__docgenInfo={description:"",methods:[],displayName:"RadioCardGroup",props:{asChild:{required:!1,tsType:{name:"boolean"},description:""},className:{required:!1,tsType:{name:"string"},description:""},defaultChecked:{required:!1,tsType:{name:"string"},description:""},direction:{required:!1,tsType:{name:"union",raw:"'row' | 'col'",elements:[{name:"literal",value:"'row'"},{name:"literal",value:"'col'"}]},description:""},name:{required:!0,tsType:{name:"string"},description:""},options:{required:!0,tsType:{name:"Array",elements:[{name:"Omit",elements:[{name:"intersection",raw:`Omit<CardProps, 'canHover' | 'isActive'> &
Pick<
  RadioProps,
  | 'name'
  | 'value'
