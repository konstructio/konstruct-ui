import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{B as n,t as r}from"./iframe-Bk40TjTJ.js";import{a as i,n as a,r as o,t as s}from"./dist-Bymfwxie.js";import{i as c,t as l}from"./dist-CkVXtOLS.js";import{n as u,t as d}from"./Radio-Cn8-UyCZ.js";var f,p=t((()=>{a(),f=s([`flex`],{variants:{direction:{row:[`flex-row`,`gap-8`],col:[`flex-col`,`gap-4`]}},defaultVariants:{direction:`col`}})})),m,h,g,_=t((()=>{c(),m=e(n(),1),i(),u(),p(),h=r(),g=({asChild:e,className:t,defaultChecked:n,direction:r,name:i,options:a,theme:s,value:c,wrapperClassName:u,onValueChange:p})=>{let g=e?l:`div`,_=c!==void 0,[v,y]=(0,m.useState)(()=>n),b=_?c:v,x=(0,m.useCallback)(e=>{_||y(e),p?.(e)},[_,p]);return(0,h.jsx)(g,{className:o(f({className:u,direction:r})),"data-theme":s,children:a.map(({value:e,...n})=>(0,h.jsx)(d,{value:e,name:i,className:o(t),checked:b===e,onChange:()=>x(e),...n},e))})},g.__docgenInfo={description:`A group of radio buttons with shared state management.
