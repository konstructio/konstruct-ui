import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{r,t as i}from"./utils-BC5-UmL9.js";import{n as a,t as o}from"./dist-DJsSzQxH.js";import{n as s,t as c}from"./Typography-BJCVf6qf.js";import{i as l,n as u,r as d,t as f}from"./civo-logo-DxCOAyFb.js";var p;function m(){return(m=e((()=>{a(),p=o([`flex`],{variants:{direction:{row:[`flex-row`,`gap-8`],col:[`flex-col`,`gap-4`]}},defaultVariants:{direction:`col`}})})))()}var h,g,_;function v(){return(v=e((()=>{h=t(),r(),l(),m(),g=n(),_=({className:e,defaultChecked:t,direction:n,name:r,options:a,theme:o,wrapperClassName:s,onValueChange:c})=>{let[l,u]=(0,h.useState)(t),f=e=>{u(e),c?.(e)};return(0,g.jsx)(`div`,{className:i(p({className:s,direction:n})),"data-theme":o,children:a.map(({value:t,...n})=>(0,g.jsx)(d,{value:t,name:r,className:i(e),checked:l===t,onChange:()=>f(t),...n},t))})},_.__docgenInfo={description:`A group of card-style radio buttons with shared state management.
