import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-es3ybDkk.js";import{u as V}from"./useToggle-C19Y0CQN.js";import{T as N}from"./Tag-CZB_uiW_.js";import{c as k,a as v}from"./index-CJCZd66Q.js";import{X as E}from"./x-BqzZv__r.js";import{C as _}from"./chevron-up-CyTKiaFR.js";import"./preload-helper-D9Z9MdNV.js";import"./index-CSw6LdrH.js";import"./index-DieQs7td.js";const O={tags:[],selectedTags:[],isOpen:!1,inputRef:null,onSelectTag(){throw new Error("Function not implemented.")},onRemoveTag(){throw new Error("Function not implemented.")},onOpen(){throw new Error("Function not implemented.")}},q=r.createContext(O),w=()=>{const e=r.useContext(q);if(!e)throw new Error("useTagSelect must be used within a TagSelectProvider");return e},I=({children:e,defaultOptions:l=[],multiselect:n=!0})=>{const s=r.useRef(null),[m,o]=V(!1),[c,b]=r.useState(l),[d,g]=r.useState([]),p=r.useCallback(u=>{if(s.current){const t=u.map(({id:f,label:i})=>({id:f,value:i}));s.current.value=JSON.stringify(t)}},[]),T=r.useCallback(u=>{const t=[...n?d:[],u];g(t);const f=t.map(i=>i.id);b(()=>n?l.filter(i=>!f.includes(i.id)):l.map(i=>({...i,isSelected:f.includes(i.id)}))),p(t),o(!1)},[l,p,n,d,o]),y=r.useCallback(u=>{const t=d.filter(i=>i.id!==u.id);g(t);const f=t.map(i=>i.id);b(()=>l.filter(i=>!f.includes(i.id))),p(t)},[l,p,d]),S=r.useCallback(u=>o(u),[o]);return a.jsx(q.Provider,{value:{tags:c,selectedTags:d,isOpen:m,inputRef:s,onSelectTag:T,onRemoveTag:y,onOpen:S},children:e})};I.__docgenInfo={description:"",methods:[],displayName:"TagSelectProvider",props:{defaultOptions:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  color?:
    | 'gray'
    | 'cyan'
    | 'gold'
...
| 'kubefirst-dark'
| 'civo-dark'
| undefined`,elements:[{name:"literal",value:"'kubefirst'"},{name:"literal",value:"'civo'"},{name:"literal",value:"'kubefirst-dark'"},{name:"literal",value:"'civo-dark'"},{name:"undefined"}]},description:""}}};const F=k(["absolute","bg-white","border","duration-100","flex","flex-col","mt-0.5","rounded","shadow-xs","top-full","transition-all","w-full","z-10","animate-in","fade-in-50","overflow-hidden","border-gray-200"]),j=({theme:e})=>{const{tags:l}=w();return a.jsx("ul",{role:"listbox","data-theme":e,className:v(F()),children:l.length>0?l.map(n=>a.jsx(R,{option:n},n.id)):a.jsx("span",{className:"text-center text-sm px-4 py-2",children:"There is not options available"})})};j.__docgenInfo={description:"",methods:[],displayName:"List",props:{theme:{required:!1,tsType:{name:"union",raw:`| 'kubefirst'
| 'civo'
| 'kubefirst-dark'
| 'civo-dark'
| undefined`,elements:[{name:"literal",value:"'kubefirst'"},{name:"literal",value:"'civo'"},{name:"literal",value:"'kubefirst-dark'"},{name:"literal",value:"'civo-dark'"},{name:"undefined"}]},description:""}}};const L=()=>{const e=r.useRef(null),{onOpen:l}=w();r.useEffect(()=>{const s=new AbortController,m=c=>{c.key==="Escape"&&l(!1)},o=c=>{e.current?.contains(c.target)||l(!1)};return document.addEventListener("keydown",m,{signal:s.signal}),document.addEventListener("mousedown",o,{signal:s.signal}),()=>{s.abort()}},[l,e]);const n=r.useCallback(s=>{s.target?.closest("[data-value]")||l(!0)},[l]);return{wrapperRef:e,handleOpen:n}},W=k(["flex","flex-col","w-full","relative","text-zinc-500"]),$=k(["my-2","cursor-pointer"]),A=k(["border","cursor-pointer","duration-250","ease-in-out","flex","items-center","justify-between","px-2","py-1","rounded","transition-all","w-full","border-gray-200"]),C=r.forwardRef(({label:e,labelClassName:l,name:n,placeholder:s="Select a value...",theme:m,wrapperClassName:o},c)=>{const b=r.useId(),{selectedTags:d,isOpen:g,onOpen:p,onRemoveTag:T,inputRef:y}=w(),{wrapperRef:S,handleOpen:u}=L();return r.useImperativeHandle(c,()=>y.current,[y]),a.jsxs("div",{ref:S,className:v(W({className:o})),"data-theme":m,children:[e?a.jsx("label",{htmlFor:n??b,className:v($({className:l})),onClick:()=>p(!0),children:e}):null,a.jsxs("div",{id:n??b,className:v(A()),role:"combobox",onClick:u,"aria-expanded":g,children:[d.length===0?a.jsx("span",{className:"text-base text-inherit select-none",children:s}):a.jsx("div",{className:"flex flex-wrap gap-1.5",children:d.map(t=>a.jsx(N,{...t,className:"select-none",rightIcon:a.jsx(E,{className:"w-3 h-3",onClick:()=>T(t)}),"data-value":t.label},t.id))}),a.jsx(_,{className:v("w-4 h-4 text-inherit transition-all duration-50 shrink-0",g?"rotate-0":"rotate-180")})]}),a.jsx("input",{ref:y,type:"text",name:n,className:"hidden"}),g?a.jsx(j,{}):null]})});C.__docgenInfo={description:"",methods:[],displayName:"Wrapper",props:{ref:{required:!1,tsType:{name:"ForwardedRef",elements:[{name:"HTMLInputElement"}],raw:"ForwardedRef<HTMLInputElement>"},description:""},theme:{required:!1,tsType:{name:"union",raw:`| 'kubefirst'
| 'civo'
| 'kubefirst-dark'
| 'civo-dark'
