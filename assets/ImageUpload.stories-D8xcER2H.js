import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{n as r,t as i}from"./Loader-yZhDQ_yw.js";import{n as a,t as o}from"./PhotoLibrary-BJXFm60r.js";import{n as s,t as c}from"./Warning-CI1c_Ho-.js";import{i as l,t as u}from"./utils-0TJZseot.js";import{n as d,t as f}from"./dist-qtULYLvt.js";import{n as p,t as m}from"./Typography-Dr4qxqZo.js";import{n as h,t as g}from"./x-i7QAllnh.js";import{n as _,t as v}from"./Button-DBH2wbJQ.js";var y;function b(){return(b=e((()=>{y=function(e){return e.Default=`default`,e.Uploading=`uploading`,e.Complete=`complete`,e.Error=`error`,e}({})})))()}var x,S,C,w,T;function E(){return(E=e((()=>{d(),x=f([`flex`,`flex-col`,`gap-2`,`w-full`],{variants:{status:{default:``,uploading:``,complete:``,error:``}},defaultVariants:{status:`default`}}),S=f([`flex`,`gap-2`,`h-15`,`items-center`,`w-full`],{variants:{status:{default:``,uploading:``,complete:``,error:``}},defaultVariants:{status:`default`}}),C=f([`flex`,`gap-4`,`grow`,`h-full`,`items-center`,`px-4`,`py-2`,`rounded`,`border`,`bg-white`,`border-gray-300`,`dark:bg-metal-800`,`dark:border-metal-700`,`kubefirst-dark:bg-slate-800`,`kubefirst-dark:border-slate-600`],{variants:{status:{default:``,uploading:``,complete:``,error:[`border-red-600`,`dark:border-red-500`,`kubefirst-dark:border-red-500`]}},defaultVariants:{status:`default`}}),w=f([`flex`,`gap-1`,`items-center`,`text-sm`,`font-medium`,`leading-5`,`text-slate-500`,`dark:text-slate-50`,`kubefirst-dark:text-slate-50`]),T=f([`text-xs`,`leading-5`,`text-slate-600`,`dark:text-slate-200`,`kubefirst-dark:text-slate-200`],{variants:{status:{default:``,uploading:``,complete:``,error:[`text-red-700`,`dark:text-red-400`,`kubefirst-dark:text-red-500`]}},defaultVariants:{status:`default`}})})))()}var D,O,k;function A(){return(A=e((()=>{D=t(),h(),r(),a(),_(),s(),l(),b(),E(),O=n(),k=({className:e,error:t,fileName:n,fileSize:r,fileUrl:a,helperText:s=`Logo should be 32 x 32 pixels with transparent background (larger images will be downscaled proportionally to fit). Accepted file type is SVG, PNG, JPEG. Max file size is 5MB.`,isRequired:l=!1,label:d=`Item logo`,labelClassName:f,labelWrapperClassName:p,name:m,onChange:h,onRemove:_,status:b=y.Default,theme:E,uploadButtonText:k=`Upload logo`,accept:A=`image/svg+xml,image/png,image/jpeg,image/jpg`,maxSize:j=5242880})=>{let M=(0,D.useId)(),N=`${M}-message`,P=(0,D.useRef)(null),F=(0,D.useRef)(null),[I,L]=(0,D.useState)(b),[R,z]=(0,D.useState)(a),[B,V]=(0,D.useState)(n),[H,U]=(0,D.useState)(r);(0,D.useEffect)(()=>()=>{F.current&&clearTimeout(F.current)},[]);let W=b===y.Default?I:b,G=a??R,K=n??B,q=r??H,J=!!t||W===y.Error,Y=e=>{let t=e.target.files?.[0];if(!t)return;if(!A.split(`,`).map(e=>e.trim()).some(e=>{if(e.includes(`*`)){let n=e.split(`/`)[0];return t.type.startsWith(n)}return t.type===e})){L(y.Error),h?.(e);return}if(t.size>j){L(y.Error),h?.(e);return}L(y.Uploading),V(t.name),U(Q(t.size));let n=new FileReader;n.onloadend=()=>{z(n.result),F.current=setTimeout(()=>{L(y.Complete)},500)},n.readAsDataURL(t),h?.(e)},X=()=>{F.current&&=(clearTimeout(F.current),null),z(void 0),V(void 0),U(void 0),L(y.Default),P.current&&(P.current.value=``),_?.()},Z=()=>{P.current?.click()},Q=e=>{if(e===0)return`0 Bytes`;let t=1024,n=[`Bytes`,`KB`,`MB`,`GB`],r=Math.floor(Math.log(e)/Math.log(t));return`${parseFloat((e/t**r).toFixed(2))}${n[r]}`},$=t||(J?`Invalid file format. Accepted file type is SVG, PNG, JPEG. Max file size is 5MB.`:s||`Logo should be 32 x 32 pixels with transparent background (larger images will be downscaled proportionally to fit). Accepted file type is SVG, PNG, JPEG. Max file size is 5MB.`);return(0,O.jsxs)(`div`,{className:u(x({status:W,className:e})),"data-theme":E,children:[d&&(0,O.jsx)(`div`,{className:u(p),children:(0,O.jsxs)(`label`,{htmlFor:M,className:u(w({className:f}),`cursor-pointer`),children:[d,l&&(0,O.jsx)(`span`,{"aria-hidden":`true`,className:`text-red-600 dark:text-red-500 text-xs mt-0.5`,children:`*`})]})}),(0,O.jsxs)(`div`,{className:u(S({status:W})),children:[(0,O.jsxs)(`div`,{className:u(C({status:W}),{"justify-between":J,"justify-start":!J}),children:[W===y.Uploading&&(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(i,{size:20,className:`shrink-0 animate-spin text-metal-400`}),K&&(0,O.jsxs)(`div`,{className:`flex flex-col items-start min-w-0 flex-1`,children:[(0,O.jsx)(`p`,{className:`text-sm leading-5 truncate w-full text-slate-800 dark:text-metal-50`,children:K}),q&&(0,O.jsx)(`p`,{className:`text-xs leading-4 text-slate-600 dark:text-metal-300 tracking-[0.15px]`,children:q})]})]}),W===y.Complete&&G&&(0,O.jsxs)(O.Fragment,{children:[(0,O.jsx)(`div`,{className:`w-8 h-8 shrink-0 relative`,children:(0,O.jsx)(`img`,{src:G,alt:K||`Uploaded image`,className:`w-full h-full object-contain`})}),K&&(0,O.jsxs)(`div`,{className:`flex flex-col items-start min-w-0 flex-1`,children:[(0,O.jsx)(`p`,{className:`text-sm leading-5 truncate w-full text-slate-800 dark:text-slate-50 kubefirst-dark:text-slate-50`,children:K}),q&&(0,O.jsx)(`p`,{className:`text-xs leading-4 text-slate-600 dark:text-slate-400 kubefirst-dark:text-slate-400 tracking-[0.15px]`,children:q})]})]}),(W===y.Default||W===y.Error&&!G)&&(0,O.jsx)(`div`,{className:`w-8 h-8 shrink-0 flex items-center justify-center`,children:(0,O.jsx)(o,{className:`w-8 h-8 text-slate-400 dark:text-slate-500 kubefirst-dark:text-slate-500`})}),J&&(0,O.jsx)(`div`,{className:`shrink-0`,children:(0,O.jsx)(c,{className:`w-5 h-5 text-red-700 dark:text-red-500 kubefirst-dark:text-red-500`})})]}),(W===y.Default||W===y.Error)&&(0,O.jsx)(v,{variant:`secondary`,onClick:Z,theme:E,className:`h-10 px-4 py-2 shrink-0`,children:k}),W===y.Uploading&&(0,O.jsx)(v,{variant:`secondary`,shape:`circle`,size:`medium`,onClick:X,theme:E,className:`shrink-0`,"aria-label":`Cancel upload`,children:(0,O.jsx)(g,{className:`w-6 h-6`})}),W===y.Complete&&(0,O.jsx)(v,{variant:`secondary`,shape:`circle`,size:`medium`,onClick:X,theme:E,className:`shrink-0`,"aria-label":`Remove file`,children:(0,O.jsx)(g,{className:`w-6 h-6`})})]}),$&&(0,O.jsxs)(`div`,{className:`flex w-full gap-2`,children:[(0,O.jsx)(`div`,{className:`flex-1 min-w-0`,children:(0,O.jsx)(`p`,{id:N,className:u(T({status:W})),children:$})}),(W===y.Default||W===y.Error)&&(0,O.jsx)(`div`,{className:`shrink-0 w-29`}),W===y.Uploading&&(0,O.jsx)(`div`,{className:`shrink-0 w-10`})]}),(0,O.jsx)(`input`,{ref:P,id:M,type:`file`,name:m,accept:A,onChange:Y,className:`hidden`,"aria-label":d?void 0:`File upload`,"aria-invalid":J||void 0,"aria-describedby":$?N:void 0,"aria-required":l||void 0})]})},k.displayName=`KonstructImageUpload`,k.__docgenInfo={description:`A file input component for uploading images with preview and validation.
...
}`,...F.parameters?.docs?.source}}}})))()}L();export{P as ImageUpload,F as Interactive,I as __namedExportsOrder,N as default};