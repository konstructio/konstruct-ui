import{j as o}from"./iframe-DP5wXfBg.js";import{D as r}from"./DateRangePicker-CMY7ltDZ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CGPp45Jz.js";import"./Typography-C1F4y8i5.js";import"./RadioGroup-CfDb2wJw.js";import"./index-D_cTyuvQ.js";import"./index-B7vETLGW.js";import"./Radio-DxgLVXPI.js";import"./Input-BCbH0ois.js";import"./Warning-WUy0snsE.js";import"./index-CSg-Iqp3.js";import"./TimePicker-Co4MW8ms.js";import"./createLucideIcon-DQdecM9J.js";import"./style-B2RaE2qd.js";import"./chevron-right-BiNAA8-O.js";import"./proxy-CUedc4FP.js";const F={title:"In Review/DateRangePicker/Dark",component:r},t={parameters:{theme:"dark"},render:()=>o.jsx(r,{defaultRange:{from:new Date(new Date().getFullYear(),new Date().getMonth(),10),to:new Date(new Date().getFullYear(),new Date().getMonth(),20)},defaultTime:{startTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),9,10),endTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),17,30)},minDate:new Date(new Date().getFullYear(),new Date().getMonth(),1),showOutsideDays:!0,onRangeChange:e=>console.log("Range changed:",e)})},a={parameters:{theme:"dark"},render:()=>o.jsx(r,{showTime:!1,onRangeChange:e=>console.log("Range changed:",e)})},n={parameters:{theme:"dark"},render:()=>o.jsx(r,{navigationMode:"together",onRangeChange:e=>console.log("Range changed:",e)})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
