import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-D9T3pWpr.js";import{t as r}from"./jsx-runtime-BPpv9Zq8.js";import{r as i,t as a}from"./utils-Cj3UL0jG.js";import{n as o,t as s}from"./dist-DdVfrpTL.js";var c,l=t((()=>{o(),c=s([`border`,`border-gray-200`,`disabled:cursor-not-allowed`,`disabled:opacity-50`,`focus-visible:outline-none`,`focus-visible:ring-1`,`focus-visible:ring-ring`,`p-2`,`placeholder:text-gray-300`,`resize-none`,`rounded-md`,`shadow-xs`,`w-full`,`focus:ring-kubefirst-primary`])})),u,d,f,p=t((()=>{u=e(n(),1),i(),l(),d=r(),f=(0,u.forwardRef)(({initialValue:e,label:t,labelWrapperClassName:n,name:r,placeholder:i,rows:o=3,theme:s,className:l,...f},p)=>{let m=(0,u.useId)(),h=r?`${m}-name`:m;return(0,d.jsxs)(`div`,{className:`flex flex-col gap-2`,"data-theme":s,children:[t?(0,d.jsx)(`div`,{className:a(n),children:(0,d.jsx)(`label`,{htmlFor:h,className:`cursor-pointer`,children:t})}):null,(0,d.jsx)(`textarea`,{id:h,ref:p,className:a(c({className:l})),rows:o,placeholder:i,value:e??f.value,...f})]})}),f.__docgenInfo={description:`A multiline text input component with optional label.
