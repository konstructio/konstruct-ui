import{r as l,R as U,j as s}from"./iframe-67S0_0YR.js";import{u as F}from"./useToggle-BMM5WpHU.js";import{L as $}from"./Loader-_hAVimZ7.js";import{B as V}from"./Badge-k90ZHaEm.js";import{T as D}from"./Typography-B8oYOtX9.js";import{a as T,c as h}from"./index-CwGTy2we.js";import"./Button-DEGVbhSP.js";import"./Checkbox-BsuKNQ2V.js";import{X as B}from"./x-CosRNdXj.js";import{P as j}from"./index-tj_dRpPR.js";function I(){return I=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},I.apply(this,arguments)}function K(t,e){if(t==null)return{};var n=J(t,e),r,i;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);for(i=0;i<a.length;i++)r=a[i],!(e.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(t,r)&&(n[r]=t[r])}return n}function J(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,a;for(a=0;a<r.length;a++)i=r[a],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}var E=l.forwardRef(function(t,e){var n=t.color,r=n===void 0?"currentColor":n,i=t.size,a=i===void 0?24:i,u=K(t,["color","size"]);return U.createElement("svg",I({ref:e,xmlns:"http://www.w3.org/2000/svg",width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:r,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},u),U.createElement("polyline",{points:"18 15 12 9 6 15"}))});E.propTypes={color:j.string,size:j.oneOfType([j.string,j.number])};E.displayName="ChevronUp";const X={options:[],selectedOptions:[],isOpen:!1,inputRef:null,onSelectOption(){throw new Error("Function not implemented.")},onRemoveOption(){throw new Error("Function not implemented.")},onOpen(){throw new Error("Function not implemented.")},isLoading:!1,noOptionsText:void 0},A=l.createContext(X),M=()=>{const t=l.useContext(A);if(!t)throw new Error("useMultiSelectDropdown must be used within a MultiSelectDropdownProvider");return t},P=({children:t,defaultOptions:e=[],multiselect:n=!0,value:r,onChange:i,onBlur:a,name:u,isLoading:O,noOptionsText:k})=>{const g=l.useRef(null),[w,x]=F(!1),[N,b]=l.useState(e),[m,S]=l.useState([]),f=r!==void 0;l.useEffect(()=>{if(!f){const p=new Set(m.map(o=>o.id));b(n?e.filter(o=>!p.has(o.id)):e.map(o=>({...o,isSelected:p.has(o.id)})))}},[e,n,f,m]),l.useEffect(()=>{if(f){const p=r||[];S(p);const o=new Set(p.map(c=>c.id));b(n?e.filter(c=>!o.has(c.id)):e.map(c=>({...c,isSelected:o.has(c.id)})))}},[r,f,e,n]);const y=l.useCallback(p=>{const o=p.map(({id:d,value:C,label:z})=>({id:d,value:C??z})),c=JSON.stringify(o);g.current&&(g.current.value=c),i&&i({target:{value:p,name:u??""}})},[i,u]),q=l.useCallback(p=>{const o=w;x(p),o&&p===!1&&a&&g.current&&a({target:g.current,type:"blur"})},[w,x,a,g]),v=l.useCallback(p=>{if(f){const d=[...n?m:[],p];y(d),q(!1);return}const o=[...n?m:[],p];S(o);const c=o.map(d=>d.id);b(()=>n?e.filter(d=>!c.includes(d.id)):e.map(d=>({...d,isSelected:c.includes(d.id)}))),y(o),q(!1)},[e,y,n,m,q,f]),H=l.useCallback(p=>{if(f){const d=m.filter(C=>C.id!==p.id);y(d);return}const o=m.filter(d=>d.id!==p.id);S(o);const c=o.map(d=>d.id);b(()=>e.filter(d=>!c.includes(d.id))),y(o)},[e,y,m,f]);return s.jsx(A.Provider,{value:{options:N,selectedOptions:m,isOpen:w,inputRef:g,onSelectOption:v,onRemoveOption:H,onOpen:q,isLoading:O,noOptionsText:k},children:t})};P.__docgenInfo={description:"",methods:[],displayName:"MultiSelectDropdownProvider",props:{defaultOptions:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
