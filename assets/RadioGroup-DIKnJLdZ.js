import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{r,t as i}from"./utils-BC5-UmL9.js";import{n as a,t as o}from"./dist-DJsSzQxH.js";import{i as s,t as c}from"./dist-CdaDnY7t.js";import{n as l,t as u}from"./Radio-BtSIiH_G.js";var d;function f(){return(f=e((()=>{a(),d=o([`flex`],{variants:{direction:{row:[`flex-row`,`gap-8`],col:[`flex-col`,`gap-4`]}},defaultVariants:{direction:`col`}})})))()}var p,m,h;function g(){return(g=e((()=>{s(),p=t(),r(),l(),f(),m=n(),h=({asChild:e,className:t,defaultChecked:n,direction:r,name:a,options:o,theme:s,value:l,wrapperClassName:f,onValueChange:h})=>{let g=e?c:`div`,_=l!==void 0,[v,y]=(0,p.useState)(()=>n),b=_?l:v,x=e=>{_||y(e),h?.(e)};return(0,m.jsx)(g,{className:i(d({className:f,direction:r})),"data-theme":s,children:o.map(({value:e,...n})=>(0,m.jsx)(u,{value:e,name:a,className:i(t),checked:b===e,onChange:()=>x(e),...n},e))})},h.__docgenInfo={description:`A group of radio buttons with shared state management.
