import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-batYq3Oy.js";import{B as E}from"./Button-C-EZiMla.js";import{M as C}from"./Modal-D48vviC9.js";import{D as s,g as b,a as A}from"./Dropdown-M2nGFDOj.js";import{c as P}from"./createLucideIcon-DCp5WCDJ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CF-xFttl.js";import"./index-DQVzZgw6.js";import"./index-Bn42e07n.js";import"./index-BzqEQCvg.js";import"./index-Dkj0d319.js";import"./index-BD9_54yh.js";import"./Combination-D6k5azhG.js";import"./x-oNu2yoxJ.js";import"./index-CCicKkly.js";import"./useToggle-CNzDlOig.js";import"./loader-CGJJ3t8V.js";import"./Typography-DUXe0q0p.js";import"./debounce-DLfH_CvB.js";import"./Loading-DVe_IbLt.js";import"./chevron-up-CzoOTSVM.js";const U=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],w=P("plus",U),re={title:"In Review/Dropdown",component:s},p={args:{options:[{label:"Talos",subLabel:"A modern OS for Kubernetes",value:"talos",leftIcon:e.jsx("img",{src:"./talos.svg",alt:"Talos Logo"})},{label:"K3S",subLabel:"Lightweight Kubernetes",value:"k3s",leftIcon:e.jsx("img",{src:"./k3s.svg",alt:"K3S Logo"})}],placeholder:"Select an option...",required:!1,labelClassName:"",isLoading:!1,name:"dropdown"},render:function(a){const[u,d]=o.useState("talos"),[m,c]=o.useState(),[D,I]=o.useState(),[O,j]=o.useState(),[M,N]=o.useState(),[V,L]=o.useState(),[y,T]=o.useState(),[S,f]=o.useState(),[x,K]=o.useState([]);return o.useEffect(()=>{(async()=>{const l=await b({page:1,pageSize:A});K(l.results.map(({id:r,name:n})=>({value:r.toString(),label:`${n.charAt(0).toLocaleUpperCase()+n.slice(1)}`})))})()},[]),e.jsxs("div",{className:"flex flex-col gap-6",children:[e.jsxs("div",{className:"max-w-87.5 flex flex-col gap-6 p-6",children:[e.jsx(s,{label:"Searchable dropdown with Kubefirst theme",onChange:({target:{value:t}})=>d(t),value:u,searchable:!0,theme:"kubefirst",...a}),e.jsx(s,{label:"Searchable dropdown with Civo theme",onChange:({target:{value:t}})=>c(t),value:m,searchable:!0,showSearchIcon:!0,inputMode:"text",highlightSearch:!0,additionalOptions:[e.jsxs("button",{className:"text-blue-600 dark:text-aurora-500",children:[e.jsx(w,{})," New Team"]})],...a}),e.jsx(s,{label:"Dropdown with Civo theme",onChange:({target:{value:t}})=>I(t),value:D,searchable:!1,...a}),e.jsx(s,{label:"Dropdown with no options text",searchable:!1,noOptionsText:"No cloud account exists",...a,options:[],additionalOptions:[e.jsxs("button",{className:"text-blue-600 dark:text-aurora-500",children:[e.jsx(w,{})," New Cloud Account"]})]}),e.jsx(s,{...a,label:"Dropdown infinity scroll without search",onChange:({target:{value:t}})=>j(t),value:O,searchable:!1,isInfiniteScrollEnabled:!0,onFetchMoreOptions:async({page:t,pageSize:l,termOfSearch:r})=>{const{results:n,totalItemsCount:g}=await b({page:t,pageSize:l,termOfSearch:r});return{data:n.map(({id:v,name:i})=>({value:v.toString(),label:`${i.charAt(0).toLocaleUpperCase()+i.slice(1)}`})),hasMore:t<=Math.ceil(g/l)}},options:x}),e.jsx(s,{...a,label:"Dropdown infinity scroll with search",onChange:({target:{value:t}})=>N(t),value:M,searchable:!0,isInfiniteScrollEnabled:!0,highlightSearch:!0,onFetchMoreOptions:async({page:t,pageSize:l,termOfSearch:r})=>{const{results:n,totalItemsCount:g}=await b({page:t,pageSize:l,termOfSearch:r});return{data:n.map(({id:v,name:i})=>({value:v.toString(),label:`${i.charAt(0).toLocaleUpperCase()+i.slice(1)}`})),hasMore:t<=Math.ceil(g/l)}},options:x})]}),e.jsxs("div",{className:"max-w-87.5 flex flex-col gap-6 p-6 bg-metal-900 rounded-sm","data-theme":"dark",children:[e.jsx(s,{label:"Searchable dropdown with Kubefirst theme",onChange:({target:{value:t}})=>L(t),value:V,searchable:!0,theme:"kubefirst",...a}),e.jsx(s,{label:"Searchable dropdown with Civo theme",onChange:({target:{value:t}})=>T(t),value:y,searchable:!0,showSearchIcon:!0,inputMode:"text",highlightSearch:!0,additionalOptions:[e.jsxs("button",{className:"text-blue-600 dark:text-aurora-500",children:[e.jsx(w,{})," New Team"]})],...a}),e.jsx(s,{label:"Dropdown with Civo theme",onChange:({target:{value:t}})=>f(t),value:S,searchable:!1,...a}),e.jsx(s,{...a,label:"Dropdown with no options text",onChange:({target:{value:t}})=>f(t),value:S,searchable:!1,noOptionsText:"No options",options:[]})]})]})}},h={render:function(){const[a,u]=o.useState(!1),[d,m]=o.useState();return e.jsxs("div",{children:[e.jsx(E,{onClick:()=>u(!0),theme:"kubefirst",children:"Open Modal with Dropdown"}),e.jsx(C,{isOpen:a,onClose:()=>u(!1),theme:"kubefirst",className:"min-h-25",children:e.jsx(C.Body,{children:e.jsx("div",{className:"p-6",children:e.jsx(s,{label:"Choose your distribution",options:[{label:"Talos",value:"talos",leftIcon:e.jsx("img",{src:"./talos.svg",alt:"Talos Logo"})},{label:"K3S",value:"k3s",leftIcon:e.jsx("img",{src:"./k3s.svg",alt:"K3S Logo"})}],placeholder:"Select an option...",onChange:({target:{value:c}})=>{console.log("value",c),m(c)},value:d,theme:"kubefirst",name:"modal-dropdown"})})})})]})}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  ...
  render: function DropdownStory(args) {
    ...
    return <div className="flex flex-col gap-6">
        ...
        <div className="max-w-87.5 flex flex-col gap-6 p-6 bg-metal-900 rounded-sm" data-theme="dark">
          <DropdownComponent label="Searchable dropdown with Kubefirst theme" onChange={({
          target: {
            value
          }
  ...
  render: function DropdownInModalStory() {
    ...
    return <div>
        ...
        <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} theme="kubefirst" className="min-h-25">
          <Modal.Body>
            <div className="p-6">
