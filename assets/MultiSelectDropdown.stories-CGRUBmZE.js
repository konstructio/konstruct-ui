import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-d5463F2f.js";import{u as F}from"./useToggle-CKE7iGx3.js";import{S as W}from"./loader-BC2PuREG.js";import{c as S,a as q}from"./index-Bn42e07n.js";import{T as I}from"./Tag-LF6AVDM6.js";import{T as P}from"./Typography-B0NnVuoh.js";import{C as $}from"./chevron-up-zSMzX_hg.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Co5HJdXs.js";import"./index-CRttB-dH.js";import"./index-B_SU4PP-.js";const z={options:[],selectedOptions:[],isOpen:!1,inputRef:null,onSelectOption(){throw new Error("Function not implemented.")},onRemoveOption(){throw new Error("Function not implemented.")},onOpen(){throw new Error("Function not implemented.")},isLoading:!1,noOptionsText:void 0},E=s.createContext(z),O=()=>{const e=s.useContext(E);if(!e)throw new Error("useMultiSelectDropdown must be used within a MultiSelectDropdownProvider");return e},R=({children:e,defaultOptions:r=[],multiselect:a=!0,value:i,onChange:p,onBlur:d,name:m,isLoading:y,noOptionsText:v})=>{const g=s.useRef(null),[x,L]=F(!1),[h,b]=s.useState(r),[f,T]=s.useState([]),u=i!==void 0;s.useEffect(()=>{if(!u){const o=new Set(f.map(n=>n.id));b(a?r.filter(n=>!o.has(n.id)):r.map(n=>({...n,isSelected:o.has(n.id)})))}},[r,a,u,f]),s.useEffect(()=>{if(u){const o=i||[];T(o);const n=new Set(o.map(c=>c.id));b(a?r.filter(c=>!n.has(c.id)):r.map(c=>({...c,isSelected:n.has(c.id)})))}},[i,u,r,a]);const w=s.useCallback(o=>{const n=o.map(({id:l,value:M,label:A})=>({id:l,value:M??A})),c=JSON.stringify(n);g.current&&(g.current.value=c),p&&p({target:{value:o,name:m??""}})},[p,m]),j=s.useCallback(o=>{const n=x;L(o),n&&o===!1&&d&&g.current&&d({target:g.current,type:"blur"})},[x,L,d,g]),_=s.useCallback(o=>{if(u){const l=[...a?f:[],o];w(l),j(!1);return}const n=[...a?f:[],o];T(n);const c=n.map(l=>l.id);b(()=>a?r.filter(l=>!c.includes(l.id)):r.map(l=>({...l,isSelected:c.includes(l.id)}))),w(n),j(!1)},[r,w,a,f,j,u]),H=s.useCallback(o=>{if(u){const l=f.filter(M=>M.id!==o.id);w(l);return}const n=f.filter(l=>l.id!==o.id);T(n);const c=n.map(l=>l.id);b(()=>r.filter(l=>!c.includes(l.id))),w(n)},[r,w,f,u]);return t.jsx(E.Provider,{value:{options:h,selectedOptions:f,isOpen:x,inputRef:g,onSelectOption:_,onRemoveOption:H,onOpen:j,isLoading:y,noOptionsText:v},children:e})};R.__docgenInfo={description:"",methods:[],displayName:"MultiSelectDropdownProvider",props:{defaultOptions:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string | number;
  label: string;
  tagLabel?: string;
  ...
  target: HTMLInputElement | null;
  type?: string;
}`,signature:{properties:[{key:"target",value:{name:"union",raw:"HTMLInputElement | null",elements:[{name:"HTMLInputElement"},{name:"null"}],required:!0}},{key:"type",value:{name:"string",required:!1}}]}},name:"event"}],return:{name:"void"}}},description:""},isLoading:{required:!1,tsType:{name:"boolean"},description:""},noOptionsText:{required:!1,tsType:{name:"string"},description:""}},composes:["VariantProps","Omit"]};const de={title:"In Review/MultiSelectDropdown",component:k},C={args:{options:[{id:"1",label:"dev: development",tagLabel:"dev",tagColor:"gray-800",value:"dev"},{id:"2",label:"qa: quality assurance",tagLabel:"qa",tagColor:"gray-800",value:"qa"},{id:"3",label:"prod: production",tagLabel:"prod",tagColor:"gray-800",value:"prod"}]},render:e=>t.jsxs("div",{className:"max-w-[300px] flex flex-col gap-3",children:[t.jsx(k,{...e,label:"Multiselect"}),t.jsx("div",{className:"border-t my-3 border-gray-200"}),t.jsx(k,{...e,label:"Single select",multiselect:!1})]})};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
    options: [{
      id: '1',
...
}`,...C.parameters?.docs?.source}}};const pe=["MultiSelectDropdown"];export{C as MultiSelectDropdown,pe as __namedExportsOrder,de as default};
