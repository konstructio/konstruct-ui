import{j as e}from"./iframe-RzY5nVzv.js";import{a as r,c}from"./index-B-7A89sm.js";import"./preload-helper-PPVm8Dsz.js";const d=r(["h-px","bg-zinc-200","w-full"],{variants:{variant:{default:""}},defaultVariants:{variant:"default"}}),s=({className:a,...n})=>e.jsx("div",{className:c(d({className:a})),...n});s.displayName="Divider";s.__docgenInfo={description:`A horizontal divider/separator line.
