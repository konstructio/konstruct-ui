import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{i as r,o as i}from"./utils-0TJZseot.js";import{d as a,i as o,o as s,r as c,t as l}from"./dist-DmmcZTDZ.js";var u,d,f;function p(){return(p=e((()=>{a(),u=t(),c(),r(),d=n(),s.register(o),f=({values:e,colors:t=[i(`--color-neutral-600`),i(`--color-emerald-400`)],borderColors:n=[i(`--color-white`),i(`--color-white`)],borderWidth:r=0,cutoutPercentage:a=80,title:o,subtitle:s,titleFontSize:c=16,subtitleFontSize:f=14,titleColor:p=i(`--color-gray-900`),subtitleColor:m=i(`--color-gray-500`),titleFontWeight:h=`bold`,subtitleFontWeight:g=`normal`,redraw:_=!0})=>{let v=(0,u.useMemo)(()=>({datasets:[{data:e,backgroundColor:t,borderWidth:r,borderColor:n}]}),[n,r,t,e]),y=(0,u.useMemo)(()=>({plugins:{legend:{display:!1}},cutout:`${a}%`,hover:{mode:null}}),[a]),b=(0,u.useMemo)(()=>{let e=[];return o&&e.push({id:`titleCenter`,beforeDraw(e){let t=e.ctx,n=e.width,r=e.height;t.restore(),t.font=`${h} ${c}px sans-serif`,t.fillStyle=p,t.textAlign=`center`,t.textBaseline=`middle`,t.fillText(o,n/2,r/2-(s?c/2:0)),t.save()}}),s&&e.push({id:`subtitleCenter`,beforeDraw(e){let t=e.ctx,n=e.width,r=e.height;t.restore(),t.font=`${g} ${f}px sans-serif`,t.fillStyle=m,t.fillText(s,n/2,r/2+f/2),t.save()}}),e},[s,m,f,g,o,p,c,h]);return(0,d.jsx)(l,{data:v,options:y,plugins:b,redraw:_})},f.__docgenInfo={description:`A doughnut/pie chart component for data visualization.
...
} satisfies Story`,...g.parameters?.docs?.source}}}})))()}v();export{g as PieChart,_ as __namedExportsOrder,h as default};