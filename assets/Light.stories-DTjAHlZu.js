...
}`,...u.parameters?.docs?.source},description:{story:`The trigger with a range already applied, as the Product Design System draws
...
picked.`,...u.parameters?.docs?.description}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'light'
  },
...
}`,...d.parameters?.docs?.source},description:{story:`Every shape the date range filter can take, side by side: the built-in
...
pair and whose inputs read numerically.`,...d.parameters?.docs?.description}}}})))()}p();export{l as CreatedDateRange,u as CreatedDateRangeSplitBadge,d as DateRangeVariations,c as Light,f as __namedExportsOrder,s as default};