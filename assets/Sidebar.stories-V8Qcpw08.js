...
@see {@link https://konstructio.github.io/konstruct-ui/?path=/docs/components-sidebar--docs Storybook}`,methods:[{name:"Footer",docblock:null,modifiers:["static"],params:[{name:"{ className, children }",optional:!1,type:null}],returns:null},{name:"Logo",docblock:null,modifiers:["static"],params:[{name:"{ children, className }",optional:!1,type:null}],returns:null},{name:"Navigation",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  isActive,
  ...delegated
}`,optional:!1,type:null}],returns:null},{name:"NavigationSeparator",docblock:null,modifiers:["static"],params:[{name:"{ className }",optional:!1,type:null}],returns:null}],displayName:"KonstructSidebar"};const ce={title:"In Review/Sidebar",component:d,decorators:[t=>{const[a,n]=o.useState(window.innerHeight),i=K(()=>n(window.innerHeight),150);return o.useEffect(()=>{const s=window.parent.document.getElementById("storybook-panel-root");if(!s)return;const r=new ResizeObserver(i);return r.observe(s),()=>{r.disconnect()}},[i]),o.useEffect(()=>{const s=c=>{c?.querySelector(".sidebar-container")&&i()},r=c=>{c.forEach(f=>{f.addedNodes.forEach(s),f.removedNodes.forEach(s)})};new MutationObserver(r).observe(window.parent.document.body,{childList:!0,subtree:!0})},[i]),e.jsx("div",{style:{margin:"-1rem",height:a},children:e.jsx(t,{})})}]},j={render:function(){const[a,n]=o.useState("kubefirst");return e.jsxs(d,{theme:a,children:[e.jsx(x,{children:e.jsxs("a",{className:"flex items-center gap-2",children:[e.jsx("img",{className:"flex-1 shrink-0 hidden md:block",src:"./logo-kubefirst.svg",alt:"Company logo"}),e.jsx("img",{className:"block h-10 w-12 md:hidden",src:"./ray.svg",alt:"Company logo"}),e.jsx(b,{variant:"labelSmall",className:"md:left-[35%] !bottom-[-20px] md:!bottom-0 text-[#ABADC6] lowercase",children:"v1.11.1"})]})}),e.jsxs(u,{className:"mt-4 md:mt-0",children:[e.jsxs(v,{children:[e.jsx(g,{children:e.jsxs("a",{className:"flex items-center gap-2 md:mt-0",children:[e.jsx(z,{className:"w-6 h-6"})," ",e.jsx(b,{variant:"body1",className:"hidden md:block text-inherit",children:"Clusters"})]})}),e.jsxs(g,{role:"button",onClick:()=>n("kubefirst"),isActive:a==="kubefirst",children:[e.jsx(W,{className:"w-6 h-6"})," ",e.jsx(b,{variant:"body1",className:"hidden md:block text-inherit",children:"Environments"})]})]}),e.jsxs(v,{title:"Admin settings",titleClassName:"uppercase hidden md:block ",children:[e.jsxs(g,{role:"button",onClick:()=>n("light"),isActive:a==="light",children:[e.jsx(G,{className:"w-6 h-6"})," ",e.jsx(b,{variant:"body1",className:"hidden md:block text-inherit",children:"Plans & Billing"})]}),e.jsx(g,{children:e.jsxs("a",{className:"flex items-center gap-2",children:[e.jsx(M,{className:"w-6 h-6"})," ",e.jsx(b,{variant:"body1",className:"hidden md:block text-inherit",children:"Cloud accounts"})]})})]})]}),e.jsx(y,{children:e.jsxs("span",{className:"text-[#81e2b4] flex items-center gap-2 justify-center font-semibold cursor-pointer",children:[e.jsx(L,{className:"w-5 h-5"})," ",e.jsx(b,{variant:"body1",className:"hidden md:block text-inherit",children:"Upgrade to Business"})]})})]})}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
