import{r as m,j as e}from"./iframe-BzlWAk8Y.js";import{T as r}from"./TimePicker-SDx1fVTk.js";import"./preload-helper-PPVm8Dsz.js";import"./Typography-0XhGnr1V.js";import"./index-B-7A89sm.js";import"./chevron-down--3HNk9op.js";import"./createLucideIcon-C7580aGU.js";const u={title:"In Review/TimePicker/Dark",component:r},t={render:()=>(m.useEffect(()=>(document.body.setAttribute("data-theme","dark"),document.body.classList.add("bg-metal-900"),()=>{document.body.removeAttribute("data-theme"),document.body.classList.remove("bg-metal-900")}),[]),e.jsxs(e.Fragment,{children:[e.jsx(r,{name:"time-12",label:"Time 12 format",isRequired:!0}),e.jsx("div",{className:"h-5"}),e.jsx(r,{name:"time-24",label:"Time 24 format",format:"24",isRequired:!0})]}))};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => {
    useEffect(() => {
