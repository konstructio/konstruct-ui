import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{i as r,n as i,r as a,t as o}from"./Select-qwDUiGc7.js";import{n as s,t as c}from"./pokemon.repository-L228hEnR.js";var l,u,d,f,p;function m(){return(m=e((()=>{r(),l=t(),s(),i(),u=n(),d={title:`In Review/Select/Dark`,component:o},f={parameters:{theme:`dark`},args:{options:[{label:`Talos`,subLabel:`A modern OS for Kubernetes`,value:`talos`,leftIcon:(0,u.jsx)(`img`,{src:`./talos.svg`,alt:`Talos Logo`})},{label:`K3S`,subLabel:`Lightweight Kubernetes`,value:`k3s`,leftIcon:(0,u.jsx)(`img`,{src:`./k3s.svg`,alt:`K3S Logo`})}],required:!1,labelClassName:``,isLoading:!1,name:`select`},render:function(e){let[t,n]=(0,l.useState)(`talos`),[r,i]=(0,l.useState)(`talos`),[s,d]=(0,l.useState)(),[f,p]=(0,l.useState)(),[m,h]=(0,l.useState)(),[g,_]=(0,l.useState)(),[v,y]=(0,l.useState)(),[b,x]=(0,l.useState)(),[S,C]=(0,l.useState)(),w=[{groupLabel:`Asia Pacific`,options:[{value:`mum1`,label:`Mumbai (mum1)`,leftIcon:`🇮🇳`}]},{groupLabel:`Europe`,options:[{value:`fra1`,label:`Frankfurt (fra1)`,leftIcon:`🇩🇪`},{value:`lon1`,label:`London (lon1)`,leftIcon:`🇬🇧`}]},{groupLabel:`North America`,options:[{value:`nyc1`,label:`New York City (nyc1)`,leftIcon:`🇺🇸`},{value:`phx1`,label:`Phoenix (phx1)`,leftIcon:`🇺🇸`}]}],[T,E]=(0,l.useState)([]);return(0,l.useEffect)(()=>{(async()=>{let e=await c({page:1,pageSize:10});E(e.results.map(({id:e,name:t})=>({value:e.toString(),label:`${t.charAt(0).toLocaleUpperCase()+t.slice(1)}`})))})()},[]),(0,u.jsx)(`div`,{className:`flex flex-col gap-6`,children:(0,u.jsxs)(`div`,{className:`max-w-87.5 flex flex-col gap-6`,children:[(0,u.jsx)(o,{label:`Searchable select with Kubefirst theme`,onChange:({target:{value:e}})=>n(e),value:t,searchable:!0,theme:`kubefirst`,...e}),(0,u.jsx)(o,{label:`Searchable select with Civo theme`,onChange:({target:{value:e}})=>i(e),value:r,searchable:!0,inputMode:`text`,highlightSearch:!0,...e}),(0,u.jsx)(o,{label:`Select with Civo theme`,onChange:({target:{value:e}})=>d(e),value:s,searchable:!1,...e}),(0,u.jsx)(o,{label:`Select with no options text`,searchable:!1,noOptionsText:`No cloud account exists`,...e,options:[],additionalOptions:[(0,u.jsxs)(`button`,{children:[(0,u.jsx)(a,{}),` New Cloud Account`]},`add-new-account`)]}),(0,u.jsx)(o,{...e,label:`Select infinity scroll without search`,onChange:({target:{value:e}})=>p(e),value:f,searchable:!1,isInfiniteScrollEnabled:!0,onFetchMoreOptions:async({page:e,pageSize:t,termOfSearch:n})=>{let{results:r,totalItemsCount:i}=await c({page:e,pageSize:t,termOfSearch:n});return{data:r.map(({id:e,name:t})=>({value:e.toString(),label:`${t.charAt(0).toLocaleUpperCase()+t.slice(1)}`})),hasMore:e<=Math.ceil(i/t)}},options:T}),(0,u.jsx)(o,{...e,label:`Select infinity scroll with search`,onChange:({target:{value:e}})=>h(e),value:m,searchable:!0,isInfiniteScrollEnabled:!0,highlightSearch:!0,onFetchMoreOptions:async({page:e,pageSize:t,termOfSearch:n})=>{let{results:r,totalItemsCount:i}=await c({page:e,pageSize:t,termOfSearch:n});return{data:r.map(({id:e,name:t})=>({value:e.toString(),label:`${t.charAt(0).toLocaleUpperCase()+t.slice(1)}`})),hasMore:e<=Math.ceil(i/t)}},options:T}),(0,u.jsx)(o,{label:`Searchable select with Kubefirst theme`,onChange:({target:{value:e}})=>_(e),value:g,searchable:!0,theme:`kubefirst`,...e}),(0,u.jsx)(o,{label:`Searchable select with Civo theme`,onChange:({target:{value:e}})=>y(e),value:v,searchable:!0,showSearchIcon:!0,inputMode:`text`,highlightSearch:!0,additionalOptions:[(0,u.jsxs)(`button`,{children:[(0,u.jsx)(a,{}),` New Team`]})],...e}),(0,u.jsx)(o,{...e,label:`Select with no options text`,onChange:({target:{value:e}})=>x(e),value:b,searchable:!1,noOptionsText:`No options`,options:[]}),(0,u.jsx)(o,{label:`Select with grouped options`,onChange:({target:{value:e}})=>C(e),value:S,searchable:!0,options:w,visibleItems:8})]})})}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
  args: {
...
} satisfies Story`,...f.parameters?.docs?.source}}},p=[`Dark`]})))()}m();export{f as Dark,p as __namedExportsOrder,d as default};