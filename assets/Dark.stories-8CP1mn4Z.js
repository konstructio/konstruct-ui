import{j as o}from"./iframe-FWjw8CEY.js";import{D as r}from"./DateRangePicker-C_SKAbTu.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BIgQ6y5l.js";import"./Typography-D57O5X4j.js";import"./RadioGroup-dgJZX6xY.js";import"./index-CoQBgGxf.js";import"./index-BORiBlUN.js";import"./Radio-C2COIXuo.js";import"./Input-BJ3cF_pQ.js";import"./Warning-i2SfFYo1.js";import"./index-BNMQzE2O.js";import"./TimePicker-D_fnQ_Jf.js";import"./createLucideIcon-D6mAEPwf.js";import"./style-CRywLndf.js";import"./chevron-right-APqxDRGJ.js";import"./proxy-BhTAT2jO.js";const F={title:"In Review/DateRangePicker/Dark",component:r},t={parameters:{theme:"dark"},render:()=>o.jsx(r,{defaultRange:{from:new Date(new Date().getFullYear(),new Date().getMonth(),10),to:new Date(new Date().getFullYear(),new Date().getMonth(),20)},defaultTime:{startTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),9,10),endTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),17,30)},minDate:new Date(new Date().getFullYear(),new Date().getMonth(),1),showOutsideDays:!0,onRangeChange:e=>console.log("Range changed:",e)})},a={parameters:{theme:"dark"},render:()=>o.jsx(r,{showTime:!1,onRangeChange:e=>console.log("Range changed:",e)})},n={parameters:{theme:"dark"},render:()=>o.jsx(r,{navigationMode:"together",onRangeChange:e=>console.log("Range changed:",e)})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
