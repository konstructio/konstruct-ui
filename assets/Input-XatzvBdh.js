import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-D9T3pWpr.js";import{t as r}from"./jsx-runtime-BPpv9Zq8.js";import{E as i,c as a,t as o}from"./components-CG1lH94F.js";import{S as s,b as c,t as l}from"./dist-CfsoYfNC.js";import{r as u,t as d}from"./utils-Cj3UL0jG.js";import{n as f,t as p}from"./dist-DdVfrpTL.js";import{n as m,t as h}from"./Typography-BiqKngpX.js";var g,_=t((()=>{f(),g=p(`bg-white,border,border-gray-300,caret-text-slate-800,disabled:cursor-not-allowed,disabled:text-slate-500,flex,focus-visible:border-transparent,focus-visible:outline-none,focus-visible:ring-1,h-10,px-2.5,py-2,rounded,text-slate-800,text-sm,transition-all,w-full,disabled:bg-gray-50,placeholder:text-slate-400,data-[error=false]:dark:focus:ring-aurora-500,data-[error=false]:focus:ring-aurora-500,dark:bg-metal-800,dark:border-metal-700,dark:caret-text-metal-50,dark:disabled:bg-metal-900,dark:disabled:placeholder:text-metal-400,dark:disabled:text-metal-400,dark:disabled:text-slate-400,dark:placeholder:text-metal-300,dark:text-slate-50,dark:text-white`.split(`,`),{variants:{variant:{default:``,error:[`pr-8`,`border-red-600`,`focus-visible:border-red-600`,`focus-visible:ring-transparent`,`dark:border-red-500`]}},defaultVariants:{variant:`default`}})})),v,y,b,x=t((()=>{v=e(n(),1),l(),o(),u(),_(),m(),y=r(),b=(0,v.forwardRef)(({className:e,error:t,helperText:n,helperTextClassName:r,isRequired:o=!1,isSearch:l=!1,label:u,labelAction:f,labelClassName:p,labelWrapperClassName:m,name:_,theme:b,type:x=`text`,...S},C)=>{let w=(0,v.useId)(),T=(0,v.useRef)(x===`password`),[E,D]=(0,v.useState)(()=>x!==`password`),O=typeof t==`string`&&t.length>=0,k=E?c:s;return(0,y.jsxs)(`div`,{className:`flex flex-col gap-2 w-full relative`,"data-theme":b,children:[u?(0,y.jsxs)(`div`,{className:d(`flex items-center justify-between`,m),children:[(0,y.jsxs)(h,{component:`label`,variant:`labelLarge`,htmlFor:w,className:d(`cursor-pointer`,`flex`,`gap-1`,`text-sm`,`font-medium`,p),children:[u,` `,o&&(0,y.jsx)(h,{component:`span`,className:d(`text-red-600`,`dark:text-red-500`,`text-xs`,`mt-0.5`),children:`*`})]}),f]}):null,(0,y.jsxs)(`div`,{className:`relative`,children:[l?(0,y.jsx)(`i`,{className:d(`absolute`,`left-2.5`,`top-1/2`,`-translate-y-1/2`,`text-slate-400`,`dark:text-metal-400`,{"text-red-700":O}),children:(0,y.jsx)(i,{className:`w-5 h-5`})}):null,(0,y.jsx)(`input`,{id:u?w:void 0,ref:C,name:_,type:E?T.current?`text`:x:`password`,"data-error":O,className:d(g({className:e,variant:O?`error`:`default`}),{"pr-10":x===`password`||O,"pl-8":l}),...S}),O?(0,y.jsx)(`i`,{className:d(`-translate-y-1/2`,`absolute`,`right-3`,`text-red-700`,`top-1/2`,`dark:text-red-500`),children:(0,y.jsx)(a,{className:`w-5 h-5`})}):null,x===`password`&&!t?(0,y.jsx)(`button`,{type:`button`,"aria-label":E?`Hide password`:`Show password`,className:d(`-translate-y-1/2`,`absolute`,`cursor-pointer`,`right-3`,`text-slate-400`,`top-1/2`),onClick:()=>D(!E),children:(0,y.jsx)(k,{className:`w-5 h-5`})}):null]}),t?(0,y.jsx)(h,{component:`span`,className:d(`text-xs`,`tracking-normal`,`text-red-700`,`dark:text-red-400`),children:t}):null,!t&&n?(0,y.jsx)(h,{component:`span`,variant:`body1`,className:d(`text-xs`,`text-slate-600`,`dark:text-slate-200`,`select-none`,`tracking-normal`,r),children:n}):null]})}),b.displayName=`KonstructInput`,b.__docgenInfo={description:`A text input component with label, error handling, and helper text support.
