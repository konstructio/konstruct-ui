import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./react-C21x__mS.js";import{t as n}from"./jsx-runtime-BdxMnOeJ.js";import{a as r,r as i,t as a}from"./utils-BC5-UmL9.js";import{n as o,t as s}from"./Typography-BJCVf6qf.js";import{n as c,t as l}from"./Card-BcxWtety.js";import{a as u,c as d,d as f,f as p,l as m,n as h,o as g,p as _,r as v,s as y,u as b}from"./dist-DmmcZTDZ.js";var x,S,C,w;function T(){return(T=e((()=>{f(),x=t(),v(),o(),i(),S=n(),g.register(u,b,p,d,y,m,_),C=[`--color-aurora-500`,`--color-rose-500`,`--color-violet-500`,`--color-emerald-500`,`--color-sky-500`,`--color-teal-500`,`--color-amber-500`,`--color-fuchsia-500`,`--color-indigo-500`,`--color-cyan-500`],w=({title:e,titleProps:t,labels:n,datasets:i,yAxisFormatter:o,showLegend:c,height:l=300,smooth:u=!0,axisColor:d=`#9F9FA9`,gridColor:f=`#45556C`,showGrid:p=!0,lineWidth:m=2,showAxisBorder:g=!1,tooltipTextColor:_=r(`--color-metal-100`),className:v})=>{let y=c===void 0?i.length>1:c,b=(0,x.useMemo)(()=>({labels:n,datasets:i.map((e,t)=>({label:e.label,data:e.data,borderColor:e.color??r(C[t%C.length]),backgroundColor:e.color??r(C[t%C.length]),borderDash:e.borderDash,borderWidth:m,pointRadius:0,pointHoverRadius:4,tension:u?.3:0,fill:!1}))}),[n,i,u,m]),w=(0,x.useMemo)(()=>({responsive:!0,maintainAspectRatio:!1,onHover:(e,t)=>{let n=e.native?.target;n&&(n.style.cursor=t.length>0?`pointer`:`default`)},interaction:{mode:`index`,intersect:!1},plugins:{legend:{display:y,position:`top`,align:`end`,labels:{color:`#9FAFBC`,font:{size:12,weight:500},usePointStyle:!0,pointStyle:`line`,boxWidth:24,padding:16}},tooltip:{enabled:!0,backgroundColor:r(`--color-metal-700`),titleColor:_,bodyColor:_,boxPadding:6,callbacks:{labelTextColor:()=>_}}},scales:{x:{grid:{color:`transparent`},ticks:{color:d,font:{size:12}},border:{display:g,color:f}},y:{grid:{color:p?f:`transparent`},ticks:{color:d,font:{size:12},callback:o?e=>o(e):void 0},border:{display:g,color:f}}}}),[y,o,d,f,p,g]);return(0,S.jsxs)(`div`,{className:a(`w-full`,v),children:[e&&(0,S.jsx)(s,{variant:`subtitle2`,className:`mb-6`,...t,children:e}),(0,S.jsx)(`div`,{style:{height:l},children:(0,S.jsx)(h,{"aria-label":e??`Line chart`,data:b,options:w})})]})},w.__docgenInfo={description:`A line chart component for time-series data visualization.
