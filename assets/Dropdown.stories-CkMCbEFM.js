import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-DF7qAw7_.js";import{B as E}from"./Button-CJIGI5qZ.js";import{M as w}from"./Modal-BHtVonUd.js";import{D as s,g as b,a as A}from"./Dropdown-7h4LXzgw.js";import{c as P}from"./createLucideIcon-DVe3sDq6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DpyVk1iN.js";import"./index-DlRhsdCg.js";import"./index-Bn42e07n.js";import"./index-Deajbd5G.js";import"./index-FO0HJOM3.js";import"./index-D9Haext7.js";import"./Combination-yh_VB9n7.js";import"./x-DNex9EFC.js";import"./index-BIJMu6Xa.js";import"./useToggle-CIq5VpPI.js";import"./Loading-BXok35Wy.js";import"./Typography-D-Bbi7UV.js";import"./debounce-PGgjQkSW.js";const U=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]],f=P("plus",U),le={title:"In Review/Dropdown",component:s},p={args:{options:[{label:"Talos",subLabel:"A modern OS for Kubernetes",value:"talos",leftIcon:e.jsx("img",{src:"./talos.svg",alt:"Talos Logo"})},{label:"K3S",subLabel:"Lightweight Kubernetes",value:"k3s",leftIcon:e.jsx("img",{src:"./k3s.svg",alt:"K3S Logo"})}],placeholder:"Select an option...",required:!1,labelClassName:"",isLoading:!1,name:"dropdown"},render:function(o){const[u,d]=a.useState("talos"),[m,c]=a.useState(),[C,k]=a.useState(),[I,D]=a.useState(),[M,j]=a.useState(),[V,O]=a.useState(),[y,L]=a.useState(),[N,K]=a.useState(),[S,T]=a.useState([]);return a.useEffect(()=>{(async()=>{const l=await b({page:1,pageSize:A});T(l.results.map(({id:n,name:r})=>({value:n.toString(),label:`${r.charAt(0).toUpperCase()+r.slice(1)}`})))})()},[]),e.jsxs("div",{className:"flex flex-col gap-6",children:[e.jsxs("div",{className:"max-w-[350px] flex flex-col gap-6 p-6",children:[e.jsx(s,{label:"Searchable dropdown with Kubefirst theme",onChange:({target:{value:t}})=>d(t),value:u,searchable:!0,theme:"kubefirst",...o}),e.jsx(s,{label:"Searchable dropdown with Civo theme",onChange:({target:{value:t}})=>c(t),value:m,searchable:!0,showSearchIcon:!0,inputMode:"text",highlightSearch:!0,additionalOptions:[e.jsxs("button",{className:"text-blue-600 dark:text-aurora-500",children:[e.jsx(f,{})," New Team"]})],...o}),e.jsx(s,{label:"Dropdown with Civo theme",onChange:({target:{value:t}})=>k(t),value:C,searchable:!1,...o}),e.jsx(s,{...o,label:"Dropdown infinity scroll without search",onChange:({target:{value:t}})=>D(t),value:I,searchable:!1,isInfiniteScrollEnabled:!0,onFetchMoreOptions:async({page:t,pageSize:l,termOfSearch:n})=>{const{results:r,totalItemsCount:g}=await b({page:t,pageSize:l,termOfSearch:n});return{data:r.map(({id:v,name:i})=>({value:v.toString(),label:`${i.charAt(0).toUpperCase()+i.slice(1)}`})),hasMore:t<=Math.ceil(g/l)}},options:S}),e.jsx(s,{...o,label:"Dropdown infinity scroll with search",onChange:({target:{value:t}})=>j(t),value:M,searchable:!0,isInfiniteScrollEnabled:!0,highlightSearch:!0,onFetchMoreOptions:async({page:t,pageSize:l,termOfSearch:n})=>{const{results:r,totalItemsCount:g}=await b({page:t,pageSize:l,termOfSearch:n});return{data:r.map(({id:v,name:i})=>({value:v.toString(),label:`${i.charAt(0).toUpperCase()+i.slice(1)}`})),hasMore:t<=Math.ceil(g/l)}},options:S})]}),e.jsxs("div",{className:"max-w-[350px] flex flex-col gap-6 p-6 bg-slate-800 rounded-sm","data-theme":"dark",children:[e.jsx(s,{label:"Searchable dropdown with Kubefirst theme",onChange:({target:{value:t}})=>O(t),value:V,searchable:!0,theme:"kubefirst",...o}),e.jsx(s,{label:"Searchable dropdown with Civo theme",onChange:({target:{value:t}})=>L(t),value:y,searchable:!0,showSearchIcon:!0,inputMode:"text",highlightSearch:!0,additionalOptions:[e.jsxs("button",{className:"text-blue-600 dark:text-aurora-500",children:[e.jsx(f,{})," New Team"]})],...o}),e.jsx(s,{label:"Dropdown with Civo theme",onChange:({target:{value:t}})=>K(t),value:N,searchable:!1,...o})]})]})}},h={render:function(){const[o,u]=a.useState(!1),[d,m]=a.useState();return e.jsxs("div",{children:[e.jsx(E,{onClick:()=>u(!0),theme:"kubefirst",children:"Open Modal with Dropdown"}),e.jsx(w,{isOpen:o,onClose:()=>u(!1),theme:"kubefirst",className:"min-h-[100px]",children:e.jsx(w.Body,{children:e.jsx("div",{className:"p-6",children:e.jsx(s,{label:"Choose your distribution",options:[{label:"Talos",value:"talos",leftIcon:e.jsx("img",{src:"./talos.svg",alt:"Talos Logo"})},{label:"K3S",value:"k3s",leftIcon:e.jsx("img",{src:"./k3s.svg",alt:"K3S Logo"})}],placeholder:"Select an option...",onChange:({target:{value:c}})=>{console.log("value",c),m(c)},value:d,theme:"kubefirst",name:"modal-dropdown"})})})})]})}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    options: [{
      label: 'Talos',
