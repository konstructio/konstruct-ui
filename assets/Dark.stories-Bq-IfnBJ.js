import{j as o}from"./iframe-B7-hRxyW.js";import{D as r}from"./DateRangePicker-C2FbPT3g.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CwGTy2we.js";import"./Typography-B4ouqvmC.js";import"./RadioGroup-DqdJLZBN.js";import"./index-B9RXIhwP.js";import"./index-DLVMC7Ux.js";import"./Radio-D8Pn3jJW.js";import"./Input-B8gOSI5U.js";import"./Warning-BbfX5Inz.js";import"./index-BsY9tzFZ.js";import"./TimePicker-dW_CDKbB.js";import"./createLucideIcon-CdjmRGOT.js";import"./style-DoWhj3ng.js";import"./chevron-right-wAUWQUK2.js";import"./proxy-BBVi9VqH.js";const F={title:"In Review/DateRangePicker/Dark",component:r},t={parameters:{theme:"dark"},render:()=>o.jsx(r,{defaultRange:{from:new Date(new Date().getFullYear(),new Date().getMonth(),10),to:new Date(new Date().getFullYear(),new Date().getMonth(),20)},defaultTime:{startTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),9,10),endTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),17,30)},minDate:new Date(new Date().getFullYear(),new Date().getMonth(),1),showOutsideDays:!0,onRangeChange:e=>console.log("Range changed:",e)})},a={parameters:{theme:"dark"},render:()=>o.jsx(r,{showTime:!1,onRangeChange:e=>console.log("Range changed:",e)})},n={parameters:{theme:"dark"},render:()=>o.jsx(r,{navigationMode:"together",onRangeChange:e=>console.log("Range changed:",e)})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
