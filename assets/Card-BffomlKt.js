import{c as e,i as t}from"./preload-helper-CCSz8wUY.js";import{t as n}from"./react-D9T3pWpr.js";import{t as r}from"./jsx-runtime-BPpv9Zq8.js";import{r as i,t as a}from"./utils-Cj3UL0jG.js";import{n as o,t as s}from"./dist-DdVfrpTL.js";var c,l,u=t((()=>{o(),c=s([`rounded-xl`,`border`,`border-gray-200`,`dark:border-metal-700`],{variants:{isActive:{true:`border-transparent`,false:``},canHover:{true:[`group`,`hover:border-transparent`],false:``}}}),l=s([`border`,`border-4`,`p-3`,`text-card-foreground`,`rounded-xl`],{variants:{isActive:{true:[`border-aurora-500`,`shadow`],false:`border-transparent`},canHover:{true:[`cursor-pointer`,`border-transparent`,`group-hover:border-aurora-500`],false:``}},compoundVariants:[{canHover:void 0,isActive:void 0,class:`border-transparent`}]})})),d,f,p,m=t((()=>{d=e(n(),1),i(),u(),f=r(),p=(0,d.forwardRef)(({className:e,theme:t,isActive:n,canHover:r,wrapperClassName:i,...o},s)=>(0,f.jsx)(`div`,{"data-theme":t,className:a(c({canHover:r,className:i,isActive:n})),children:(0,f.jsx)(`div`,{ref:s,className:a(l({className:e,isActive:n,canHover:r})),...o})})),p.displayName=`Card`,p.__docgenInfo={description:`A container card component with optional hover and active states.
