import{r as o,j as r}from"./iframe-CnMfofFe.js";import{S as k}from"./index-IjtP-zJr.js";import{a as v,c as t}from"./index-B-7A89sm.js";import{R as w}from"./Radio-DN1h5VaC.js";const b=v(["flex"],{variants:{direction:{row:["flex-row","gap-8"],col:["flex-col","gap-4"]}},defaultVariants:{direction:"col"}}),C=({asChild:s,className:i,defaultChecked:n,direction:l,name:d,options:c,theme:m,wrapperClassName:p,onValueChange:a})=>{const u=s?k:"div",[h,f]=o.useState(()=>n),y=o.useCallback(e=>{f(e),a?.(e)},[a]);return r.jsx(u,{className:t(b({className:p,direction:l})),"data-theme":m,children:c.map(({value:e,...g})=>r.jsx(w,{value:e,name:d,className:t(i),checked:h===e,onChange:()=>y(e),...g},e))})};C.__docgenInfo={description:`A group of radio buttons with shared state management.
