import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{c as i,a as d}from"./index-Cr-WShRT.js";import{I as g}from"./Input-LIoFfmwX.js";import{T as l}from"./Typography-tJGEAoTC.js";import{r as T}from"./iframe-C0Xxq_YC.js";import{B as j}from"./Button-C62HWBd_.js";import"./index-DCDEqv_t.js";import"./index-D8egyEJe.js";const v=i(["table-auto","w-full","border-collapse","border-spacing-0","rounded"]),N=i(["h-8","text-inherit","[&>td]:py-3","[&>td]:px-4","text-slate-700","hover:bg-zinc-100","hover:cursor-pointer"],{variants:{isSelected:{true:"bg-purple-50",false:""}}}),w=i(["h-[18px]","bg-slate-100","[&>tr>th]:py-3","[&>tr>th]:px-4","[&>tr>th]:uppercase","text-left"]),C=i([]),h=({children:a,className:s,...r})=>e.jsx("tbody",{className:d(C({className:s})),...r,children:a});h.__docgenInfo={description:"",methods:[],displayName:"Body",composes:["PropsWithChildren","VariantProps"]};const u=({children:a,...s})=>e.jsxs("div",{className:"flex px-4 py-6 rounded-t",children:[e.jsx(g,{className:"!w-1/3",...s}),e.jsx("div",{className:"w-1/4 flex justify-end",children:a})]});u.__docgenInfo={description:"",methods:[],displayName:"Filter",props:{placeholder:{required:!1,tsType:{name:"string"},description:""}},composes:["PropsWithChildren"]};const y=({children:a,className:s,...r})=>e.jsx("thead",{className:d(w({className:s})),...r,children:a});y.__docgenInfo={description:"",methods:[],displayName:"Head",composes:["PropsWithChildren","VariantProps"]};const x=({children:a,className:s,width:r,isSelected:o,onSelect:b,...f})=>e.jsx("tr",{style:{width:r},onClick:b,className:d(N({className:s,isSelected:o})),...f,children:a});x.__docgenInfo={description:"",methods:[],displayName:"Row",props:{width:{required:!1,tsType:{name:"string"},description:""},isSelected:{required:!1,tsType:{name:"boolean"},description:""},onSelect:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}},composes:["PropsWithChildren","VariantProps"]};const t=({children:a,className:s,theme:r,...o})=>e.jsx("table",{className:d(v({className:s})),"data-theme":r,...o,children:a});t.Body=h;t.Filter=u;t.Head=y;t.Row=x;t.__docgenInfo={description:"",methods:[{name:"Body",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...delegated }",optional:!1,type:null}],returns:null},{name:"Filter",docblock:null,modifiers:["static"],params:[{name:"{ children, ...delegated }",optional:!1,type:null}],returns:null},{name:"Head",docblock:null,modifiers:["static"],params:[{name:"{ children, className, ...delegated }",optional:!1,type:null}],returns:null},{name:"Row",docblock:null,modifiers:["static"],params:[{name:`{
  children,
  className,
  width,
  isSelected,
