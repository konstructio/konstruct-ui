import{r as l,j as e}from"./iframe-DP5wXfBg.js";import{R as x,S as o}from"./civo-logo-CEzfzWLv.js";import{a as b,c as d}from"./index-CGPp45Jz.js";import{T as s}from"./Typography-C1F4y8i5.js";import"./preload-helper-PPVm8Dsz.js";import"./Card-FTag_oH6.js";import"./Radio-DxgLVXPI.js";const N=b(["flex"],{variants:{direction:{row:["flex-row","gap-8"],col:["flex-col","gap-4"]}},defaultVariants:{direction:"col"}}),n=({className:r,defaultChecked:m,direction:p,name:c,options:u,theme:C,wrapperClassName:h,onValueChange:i})=>{const[v,f]=l.useState(m),g=l.useCallback(a=>{f(a),i?.(a)},[i]);return e.jsx("div",{className:d(N({className:h,direction:p})),"data-theme":C,children:u.map(({value:a,...w})=>e.jsx(x,{value:a,name:c,className:d(r),checked:v===a,onChange:()=>g(a),...w},a))})};n.__docgenInfo={description:`A group of card-style radio buttons with shared state management.
