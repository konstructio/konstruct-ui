import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r}from"./iframe-D4eurkNF.js";import{u as O}from"./useToggle-D-1Zefd9.js";import{T as R}from"./Tag-hmIuu3Q9.js";import{c as k,a as b}from"./index-Cr-WShRT.js";import{X as P}from"./x-D294lwNe.js";import{C as F}from"./chevron-up-BbmVU4i6.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DUfHYozX.js";import"./index-be20sKsB.js";const L={tags:[],selectedTags:[],isOpen:!1,inputRef:null,onSelectTag(){throw new Error("Function not implemented.")},onRemoveTag(){throw new Error("Function not implemented.")},onOpen(){throw new Error("Function not implemented.")}},j=r.createContext(L),w=()=>{const e=r.useContext(j);if(!e)throw new Error("useTagSelect must be used within a TagSelectProvider");return e},C=({children:e,defaultOptions:l=[],multiselect:n=!0})=>{const s=r.useRef(null),[o,u]=O(!1),[p,c]=r.useState(l),[m,g]=r.useState([]),f=r.useCallback(d=>{if(s.current){const t=d.map(({id:v,label:i})=>({id:v,value:i}));s.current.value=JSON.stringify(t)}},[]),T=r.useCallback(d=>{const t=[...n?m:[],d];g(t);const v=t.map(i=>i.id);c(()=>n?l.filter(i=>!v.includes(i.id)):l.map(i=>({...i,isSelected:v.includes(i.id)}))),f(t),u(!1)},[l,f,n,m,u]),y=r.useCallback(d=>{const t=m.filter(i=>i.id!==d.id);g(t);const v=t.map(i=>i.id);c(()=>l.filter(i=>!v.includes(i.id))),f(t)},[l,f,m]),S=r.useCallback(d=>u(d),[u]);return a.jsx(j.Provider,{value:{tags:p,selectedTags:m,isOpen:o,inputRef:s,onSelectTag:T,onRemoveTag:y,onOpen:S},children:e})};C.__docgenInfo={description:"",methods:[],displayName:"TagSelectProvider",props:{defaultOptions:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  color?:
    | 'gray'
    | 'cyan'
    | 'gold'
...
| 'colony-dark'
| 'civo-dark'
| undefined`,elements:[{name:"literal",value:"'kubefirst'"},{name:"literal",value:"'colony'"},{name:"literal",value:"'civo'"},{name:"literal",value:"'kubefirst-dark'"},{name:"literal",value:"'colony-dark'"},{name:"literal",value:"'civo-dark'"},{name:"undefined"}]},description:""}}};const A=()=>{const e=r.useRef(null),{onOpen:l}=w();r.useEffect(()=>{const s=new AbortController,o=p=>{p.key==="Escape"&&l(!1)},u=p=>{var c;(c=e.current)!=null&&c.contains(p.target)||l(!1)};return document.addEventListener("keydown",o,{signal:s.signal}),document.addEventListener("mousedown",u,{signal:s.signal}),()=>{s.abort()}},[l,e]);const n=r.useCallback(s=>{const o=s.target;(o==null?void 0:o.closest("[data-value]"))||l(!0)},[l]);return{wrapperRef:e,handleOpen:n}},H=k(["flex","flex-col","w-full","relative","text-zinc-500"]),z=k(["my-2","cursor-pointer"]),D=k(["border","cursor-pointer","duration-250","ease-in-out","flex","items-center","justify-between","px-2","py-1","rounded","transition-all","w-full","border-gray-200"]),_=r.forwardRef(({label:e,labelClassName:l,name:n,placeholder:s="Select a value...",theme:o,wrapperClassName:u},p)=>{const c=r.useId(),{selectedTags:m,isOpen:g,onOpen:f,onRemoveTag:T,inputRef:y}=w(),{wrapperRef:S,handleOpen:d}=A();return r.useImperativeHandle(p,()=>y.current,[y]),a.jsxs("div",{ref:S,className:b(H({className:u})),"data-theme":o,children:[e?a.jsx("label",{htmlFor:n??c,className:b(z({className:l})),onClick:()=>f(!0),children:e}):null,a.jsxs("div",{id:n??c,className:b(D()),role:"combobox",onClick:d,"aria-expanded":g,children:[m.length===0?a.jsx("span",{className:"text-base text-inherit select-none",children:s}):a.jsx("div",{className:"flex flex-wrap gap-1.5",children:m.map(t=>a.jsx(R,{...t,className:"select-none",rightIcon:a.jsx(P,{className:"w-3 h-3",onClick:()=>T(t)}),"data-value":t.label},t.id))}),a.jsx(F,{className:b("w-4 h-4 text-inherit transition-all duration-50 shrink-0",g?"rotate-0":"rotate-180")})]}),a.jsx("input",{ref:y,type:"text",name:n,className:"hidden"}),g?a.jsx(E,{}):null]})});_.__docgenInfo={description:"",methods:[],displayName:"Wrapper",props:{ref:{required:!1,tsType:{name:"ForwardedRef",elements:[{name:"HTMLInputElement"}],raw:"ForwardedRef<HTMLInputElement>"},description:""},theme:{required:!1,tsType:{name:"union",raw:`| 'kubefirst'
| 'colony'
| 'civo'
| 'kubefirst-dark'
| 'colony-dark'
...
}`,...(I=(q=h.parameters)==null?void 0:q.docs)==null?void 0:I.source}}};const ae=["TagSelect"];export{h as TagSelect,ae as __namedExportsOrder,ee as default};
