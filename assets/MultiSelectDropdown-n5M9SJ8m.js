import{r as l,R,j as s}from"./iframe-BV61N9iv.js";import{u as z}from"./useToggle-YfRRhnBG.js";import{S as $}from"./loader-DH19ZKWn.js";import{B as U}from"./Badge-kK8ZFl5p.js";import{T as D}from"./Typography-sshlW9sh.js";import{a as S,c as w}from"./index-B-7A89sm.js";import{X as B}from"./x-DPOtP9lw.js";import{P as j}from"./index-DbSf99dR.js";function I(){return I=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},I.apply(this,arguments)}function K(t,e){if(t==null)return{};var r=J(t,e),n,i;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(t);for(i=0;i<a.length;i++)n=a[i],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(t,n)&&(r[n]=t[n])}return r}function J(t,e){if(t==null)return{};var r={},n=Object.keys(t),i,a;for(a=0;a<n.length;a++)i=n[a],!(e.indexOf(i)>=0)&&(r[i]=t[i]);return r}var L=l.forwardRef(function(t,e){var r=t.color,n=r===void 0?"currentColor":r,i=t.size,a=i===void 0?24:i,u=K(t,["color","size"]);return R.createElement("svg",I({ref:e,xmlns:"http://www.w3.org/2000/svg",width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:n,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},u),R.createElement("polyline",{points:"18 15 12 9 6 15"}))});L.propTypes={color:j.string,size:j.oneOfType([j.string,j.number])};L.displayName="ChevronUp";const X={options:[],selectedOptions:[],isOpen:!1,inputRef:null,onSelectOption(){throw new Error("Function not implemented.")},onRemoveOption(){throw new Error("Function not implemented.")},onOpen(){throw new Error("Function not implemented.")},isLoading:!1,noOptionsText:void 0},V=l.createContext(X),M=()=>{const t=l.useContext(V);if(!t)throw new Error("useMultiSelectDropdown must be used within a MultiSelectDropdownProvider");return t},P=({children:t,defaultOptions:e=[],multiselect:r=!0,value:n,onChange:i,onBlur:a,name:u,isLoading:x,noOptionsText:q})=>{const m=l.useRef(null),[v,T]=z(!1),[O,h]=l.useState(e),[g,k]=l.useState([]),f=n!==void 0;l.useEffect(()=>{if(!f){const p=new Set(g.map(o=>o.id));h(r?e.filter(o=>!p.has(o.id)):e.map(o=>({...o,isSelected:p.has(o.id)})))}},[e,r,f,g]),l.useEffect(()=>{if(f){const p=n||[];k(p);const o=new Set(p.map(c=>c.id));h(r?e.filter(c=>!o.has(c.id)):e.map(c=>({...c,isSelected:o.has(c.id)})))}},[n,f,e,r]);const y=l.useCallback(p=>{const o=p.map(({id:d,value:N,label:F})=>({id:d,value:N??F})),c=JSON.stringify(o);m.current&&(m.current.value=c),i&&i({target:{value:p,name:u??""}})},[i,u]),b=l.useCallback(p=>{const o=v;T(p),o&&p===!1&&a&&m.current&&a({target:m.current,type:"blur"})},[v,T,a,m]),H=l.useCallback(p=>{if(f){const d=[...r?g:[],p];y(d),b(!1);return}const o=[...r?g:[],p];k(o);const c=o.map(d=>d.id);h(()=>r?e.filter(d=>!c.includes(d.id)):e.map(d=>({...d,isSelected:c.includes(d.id)}))),y(o),b(!1)},[e,y,r,g,b,f]),W=l.useCallback(p=>{if(f){const d=g.filter(N=>N.id!==p.id);y(d);return}const o=g.filter(d=>d.id!==p.id);k(o);const c=o.map(d=>d.id);h(()=>e.filter(d=>!c.includes(d.id))),y(o)},[e,y,g,f]);return s.jsx(V.Provider,{value:{options:O,selectedOptions:g,isOpen:v,inputRef:m,onSelectOption:H,onRemoveOption:W,onOpen:b,isLoading:x,noOptionsText:q},children:t})};P.__docgenInfo={description:"",methods:[],displayName:"MultiSelectDropdownProvider",props:{defaultOptions:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  /** Optional value (defaults to label if not provided) */
  value?: string;
}`,signature:{properties:[{key:"id",value:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}],required:!0},description:"Unique identifier for the option"},{key:"label",value:{name:"string",required:!0},description:"Display label for the option"},{key:"badge",value:{name:"string",required:!1},description:"Optional badge text displayed next to the label"},{key:"value",value:{name:"string",required:!1},description:"Optional value (defaults to label if not provided)"}]}}],raw:"MultiSelectDropdownOption[]",required:!0}},{key:"name",value:{name:"string",required:!0}}]},required:!0}}]}},name:"params"}],return:{name:"void"}}},description:""},onBlur:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: { target: HTMLInputElement | null; type?: string }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ target: HTMLInputElement | null; type?: string }",signature:{properties:[{key:"target",value:{name:"union",raw:"HTMLInputElement | null",elements:[{name:"HTMLInputElement"},{name:"null"}],required:!0}},{key:"type",value:{name:"string",required:!1}}]}},name:"event"}],return:{name:"void"}}},description:""}}};const G=S(["cursor-pointer","py-1.5","px-2","last:pb-2","first:pt-2","h-full","flex","items-center","gap-2","hover:bg-gray-50","focus:bg-gray-50","dark:hover:bg-metal-700","dark:focus:bg-metal-700"],{variants:{isSelected:{true:"",false:""}},compoundVariants:[{isSelected:!0,class:["bg-slate-50","dark:bg-metal-700"]}],defaultVariants:{isSelected:!1}}),C=({option:t,theme:e,isSelected:r,className:n})=>{const{onSelectOption:i}=M();return s.jsxs("li",{role:"option","data-theme":e,className:w(G({isSelected:r}),n),onClick:()=>i(t),children:[s.jsx(D,{variant:"body2",children:t.label}),t.badge&&s.jsx(U,{label:t.badge})]})};C.__docgenInfo={description:"",methods:[],displayName:"Item",props:{option:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  /** Unique identifier for the option */
  id: string | number;
  /** Display label for the option */
  label: string;
