import{j as o}from"./iframe-CrqmAXTA.js";import{D as r}from"./DateRangePicker-DV-YQg2v.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B-7A89sm.js";import"./Typography-CSTWAyVB.js";import"./RadioGroup-BbDOkTVQ.js";import"./index-0erROcmX.js";import"./index-dDb3DRV8.js";import"./Radio-CcuTWOyG.js";import"./Input-AtgvYN56.js";import"./Warning-Cg0C8SdD.js";import"./index-DoZvAR3P.js";import"./TimePicker-DwiVg59S.js";import"./createLucideIcon-Bi5YGLB_.js";import"./style-BUq82bvi.js";import"./chevron-right-tyddMeK9.js";import"./proxy-Dq547Jbg.js";const F={title:"In Review/DateRangePicker/Dark",component:r},t={parameters:{theme:"dark"},render:()=>o.jsx(r,{defaultRange:{from:new Date(new Date().getFullYear(),new Date().getMonth(),10),to:new Date(new Date().getFullYear(),new Date().getMonth(),20)},defaultTime:{startTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),9,10),endTime:new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate(),17,30)},minDate:new Date(new Date().getFullYear(),new Date().getMonth(),1),showOutsideDays:!0,onRangeChange:e=>console.log("Range changed:",e)})},a={parameters:{theme:"dark"},render:()=>o.jsx(r,{showTime:!1,onRangeChange:e=>console.log("Range changed:",e)})},n={parameters:{theme:"dark"},render:()=>o.jsx(r,{navigationMode:"together",onRangeChange:e=>console.log("Range changed:",e)})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    theme: 'dark'
  },
