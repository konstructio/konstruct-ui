...
| 'colony-dark'
| 'civo-dark'
| undefined`,elements:[{name:"literal",value:"'kubefirst'"},{name:"literal",value:"'colony'"},{name:"literal",value:"'civo'"},{name:"literal",value:"'kubefirst-dark'"},{name:"literal",value:"'colony-dark'"},{name:"literal",value:"'civo-dark'"},{name:"undefined"}]},description:""},wrapperClassName:{required:!1,tsType:{name:"string"},description:""},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""}}};const S={title:"In Review/RadioCardGroup",component:i},l={args:{defaultChecked:"option-1",options:[{label:e.jsx(o,{}),value:"option-1",wrapperClassName:"w-[200px]"},{label:e.jsx(o,{}),value:"option-2",wrapperClassName:"w-[200px]"},{label:e.jsx(o,{}),value:"option-3",wrapperClassName:"w-[200px]"}]},render:r=>e.jsxs("div",{className:"w-[350px] flex flex-col gap-3",children:[e.jsx("h6",{children:"Row"}),e.jsx(i,{...r,name:"radio-card-group-1",direction:"row"}),e.jsx("h6",{className:"mt-5",children:"Column"}),e.jsx(i,{...r,name:"radio-card-group-2"})]})};var d,m,c;l.parameters={...l.parameters,docs:{...(d=l.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
} satisfies Story`,...(c=(m=l.parameters)==null?void 0:m.docs)==null?void 0:c.source}}};const A=["RadioCardGroup"];export{l as RadioCardGroup,A as __namedExportsOrder,S as default};
