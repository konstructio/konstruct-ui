 ...
 */
export interface TriggerProps extends VariantProps<typeof triggerVariants>, React.HTMLAttributes<HTMLDivElement> {
 ...
 */
export interface ListProps extends React.HTMLAttributes<HTMLDivElement>, PropsWithChildren {
