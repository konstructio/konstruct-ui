...
export const NetworkAltIcon = forwardRef<SVGSVGElement, IconProps>(
  ({ size = 24, color = 'currentColor', ...props }, ref) => (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M10 10H6V6H10V10ZM7 9H9V7H7V9Z" fill={color} />
      <path
...
NetworkAltIcon.displayName = 'KonstructNetworkAltIcon';

export default NetworkAltIcon;
