...
export const AllStatesVertical: Story = {
  ...
  render: () => (
    <div className="flex gap-12">
      ...
      <div className="flex flex-col gap-6">
        <h4 className="text-sm font-medium text-slate-400">With Connectors</h4>
        <StepperComponent
          steps={[
  ...
  render: () => (
    <div className="flex gap-12">
      <div className="flex flex-col gap-2">
        <h4 className="text-sm font-medium text-slate-400 mb-2">Small</h4>
        <StepperComponent steps={basicSteps} size="small" />
      </div>

      <div className="flex flex-col gap-2">
        <h4 className="text-sm font-medium text-slate-400 mb-2">Default</h4>
        <StepperComponent steps={basicSteps} size="default" />
      </div>

      <div className="flex flex-col gap-2">
        <h4 className="text-sm font-medium text-slate-400 mb-2">Large</h4>
...
export const HorizontalSizes: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-8">
      <div>
        <h4 className="text-sm font-medium text-slate-400 mb-4">Small</h4>
      ...
      <div>
        <h4 className="text-sm font-medium text-slate-400 mb-4">Default</h4>
        <div className="max-w-xl">
          <StepperComponent
            steps={basicSteps}
            orientation="horizontal"
      ...
      <div>
        <h4 className="text-sm font-medium text-slate-400 mb-4">Large</h4>
        <div className="max-w-xl">
          <StepperComponent
            steps={basicSteps}
            orientation="horizontal"
